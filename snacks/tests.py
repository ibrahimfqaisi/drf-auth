...
class SnackTest(APITestCase):
    ...
    def test_snacks_model(self):
        ...
        self.assertEqual(actual_name, "mansef")
        self.assertEqual(
            actual_desc, "yamee"
        )
    ...
    def test_get_snack_list(self):
        ...
        self.assertEqual(snacks[0]["title"], "mansef")
    ...
    def test_update_snack(self):
        ...
        # Get the updated snack from the database
        updated_snack = Snack.objects.get(id=1)

        # Assert that the snack details have been updated
        self.assertEqual(updated_snack.title, updated_data["title"])
        self.assertEqual(updated_snack.desc, updated_data["desc"])
